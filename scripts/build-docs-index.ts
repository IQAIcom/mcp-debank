...
async function main() {
	...
	// Biome requires tabs and unquoted object keys. We use a custom serializer
	// instead of JSON.stringify so the generated file passes `pnpm lint` without
	// needing a post-generation format pass.
